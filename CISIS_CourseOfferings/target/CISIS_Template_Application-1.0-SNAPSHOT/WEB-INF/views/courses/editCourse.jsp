            ...
            <spring:nestedPath path="course">
                <table>
                    ...
                    <tr>
                        <td>
                            Academic Year: 
                            <form:select items="${sessionScope.academic_year}" path="year" itemLabel="description" itemValue="codeValueSequence">                        
                            </form:select>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>
                            Location: 
                            <form:select path="location" items="${sessionScope.location}" itemLabel="description" itemValue="codeValueSequence">
                            </form:select>
                        </td>
                    </tr>
                    <tr>
